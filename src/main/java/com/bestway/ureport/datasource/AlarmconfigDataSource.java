...
/**
 * @Type AlarmconfigDataSource.java
 * @author: Ken
 * @date: 2021/8/6 16:56
 * @description: alarmconfig数据源
 */
@Component
@Slf4j
public class AlarmconfigDataSource implements BuildinDatasource {

    private final String DATA_SOURCE_NAME = "alarmconfig";
