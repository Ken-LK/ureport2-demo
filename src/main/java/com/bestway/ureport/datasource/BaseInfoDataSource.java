...
/**
 * @Type ConfigDataSource.java
 * @author: Ken
 * @date: 2021/8/6 16:34
 * @description: baseinfo数据源
 */
@Component
@Slf4j
public class BaseInfoDataSource implements BuildinDatasource {

    private final String DATA_SOURCE_NAME = "baseinfo";
